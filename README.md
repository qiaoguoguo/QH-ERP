...
当前 `main` 已完成从 `000` 到 `019` 的基础阶段，并完成页面基础体验治理。`019 批次、序列号与来源去向追溯基础` 已合入并推送到 `origin/main`，在 017 质量状态和 018 可用量底座之上补齐了物料追踪方式、批次/序列库存底账、核心单据追踪分配、质量冻结联动和来源去向追溯。
...
- [仓库规范](AGENTS.md)
- [文档索引](docs/README.md)
- [当前节点交接报告](docs/handoffs/2026-07-12-project-handoff-current.md)
