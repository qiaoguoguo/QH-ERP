...
from (
	values
		...
		('financial-close:bank-reconciliation:view', '查看银行对账', 'financial-close:bank-reconciliation', '/gl/bank-statements', 'GET', '/api/admin/bank-statements/**,/api/admin/bank-reconciliations/**', 897),
		('financial-close:bank-reconciliation:import', '导入银行流水', 'financial-close:bank-reconciliation', '/gl/bank-statements', 'POST', '/api/admin/bank-statements/**,/api/admin/bank-statement-lines/**', 898),
