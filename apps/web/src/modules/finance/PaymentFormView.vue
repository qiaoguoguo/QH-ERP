...
<template>
  <MasterDataTableView :title="pageTitle" description="登记业务付款草稿，过账前不更新应付余额；多目标分配可在对账核销工作台继续处理。">
    <template #alerts>
    ...
    <el-form label-position="top" class="finance-form">
      <div class="finance-form-grid">
        ...
        <el-form-item label="付款方式">
          <el-select v-model="form.method" data-test="payment-method-select" name="payment-method" placeholder="选择付款方式" :disabled="isReadonlyEdit" :class="{ 'is-disabled': isReadonlyEdit }">
