  ...
  <MasterDataTableView title="预付款" description="展示已过账付款形成的供应商未核销余额。">
    ...
    <div class="table-scroll">
      <el-table :data="records" :empty-text="loading ? '加载中' : '暂无预付款'">
        ...
        <el-table-column label="操作" min-width="110"><template #default="{ row }"><el-button text @click="router.push({ name: 'finance-prepayment-detail', params: { id: row.id } })">详情</el-button></template></el-table-column>
      </el-table>
    </div>
