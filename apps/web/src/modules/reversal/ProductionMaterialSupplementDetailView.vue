...
<template>
  <MasterDataTableView title="生产补料详情" description="查看生产补料来源、明细、库存出库、成本影响和反向追溯。">
    ...
    <div v-else-if="record" class="detail-layout">
      <section data-test="material-supplement-detail-summary" class="detail-summary-strip">
        <div class="detail-summary-strip__item">
          <span>补料单号</span>
          <strong>{{ record.supplementNo }}</strong>
        </div>
        <div class="detail-summary-strip__item">
          <span>状态</span>
      ...
      <section class="section-card">
        <h2>基础信息</h2>
        <dl data-test="material-supplement-detail-fields" class="detail-field-list">
          <div>
            <dt>生产工单</dt>
      ...
      <section class="section-card">
        <h2>补料明细</h2>
        <div data-test="material-supplement-lines-table-scroll" class="table-scroll">
      ...
      <ProductionReversalTraceDrawer
        ...
        :rows="traceRows"
        data-test="material-supplement-reversal-trace-drawer"
