...
export function salesOrderLineDraftFromRecord(line: SalesOrderLineRecord): SalesOrderLineDraft {
  return {
    ...
    priceSourceNo: line.priceSourceNo ?? line.sourceNo ?? '',
    quoteLineId: line.quoteLineId ?? line.sourceQuoteLineId ?? (line.priceSourceType && line.priceSourceType !== 'MANUAL' ? null : undefined),
