...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    name: 'sales-orders',
    meta: { requiresAuth: true, requiredPermission: 'sales:order:view' },
    component: placeholder('销售订单', '销售订单页面将在后续任务接入。'),
  },
  {
    path: '/sales/orders/create',
    name: 'sales-order-create',
    meta: { requiresAuth: true, requiredPermission: 'sales:order:create' },
    component: placeholder('新建销售订单', '销售订单表单将在后续任务接入。'),
  },
  {
    path: '/sales/orders/:id',
    name: 'sales-order-detail',
    meta: { requiresAuth: true, requiredPermission: 'sales:order:view' },
    component: placeholder('销售订单详情', '销售订单详情将在后续任务接入。'),
  },
  {
    path: '/sales/orders/:id/edit',
    name: 'sales-order-edit',
    meta: { requiresAuth: true, requiredPermission: 'sales:order:update' },
    component: placeholder('编辑销售订单', '销售订单编辑页面将在后续任务接入。'),
  },
  {
