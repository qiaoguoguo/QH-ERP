...
import { financialCloseRoutes, firstFinancialCloseRouteByPermission } from './modules/financialCloseRoutes'
...
const routes: RouteRecordRaw[] = [
  ...
  {
    path: '/platform/data-repairs',
    name: 'platform-data-repairs',
    meta: { requiresAuth: true, requiredPermission: 'platform:data-repair:view' },
    component: () => import('../modules/platform/dataRepairs/DataRepairListView.vue'),
  },
  {
    path: '/platform/data-repairs/create',
    name: 'platform-data-repair-create',
    meta: { requiresAuth: true, requiredPermission: 'platform:data-repair:create' },
    component: () => import('../modules/platform/dataRepairs/DataRepairCreateView.vue'),
  },
  {
    path: '/platform/data-repairs/:id',
    name: 'platform-data-repair-detail',
    meta: { requiresAuth: true, requiredPermission: 'platform:data-repair:view' },
    props: (route) => ({ repairId: route.params.id }),
    component: () => import('../modules/platform/dataRepairs/DataRepairDetailView.vue'),
  },
  {
    path: '/platform/history-imports',
    name: 'platform-history-imports',
    meta: { requiresAuth: true, requiredPermission: 'platform:history-import:view' },
    component: () => import('../modules/platform/historyImports/HistoryImportListView.vue'),
  },
  {
    path: '/platform/history-imports/:id',
    name: 'platform-history-import-detail',
    meta: { requiresAuth: true, requiredPermission: 'platform:history-import:view' },
    props: (route) => ({ taskId: route.params.id }),
    component: () => import('../modules/platform/historyImports/HistoryImportDetailView.vue'),
  },
  {
    path: '/platform/delivery-assets',
    name: 'platform-delivery-assets',
    meta: { requiresAuth: true, requiredPermission: 'platform:delivery-asset:view' },
    component: () => import('../modules/platform/deliveryAssets/DeliveryAssetsView.vue'),
  },
  {
  ...
  },
  {
    ...
    meta: { requiresAuth: true, requiredPermission: 'finance:sales-invoice:view' },
    component: () => import('../modules/finance/SalesInvoiceListView.vue'),
  },
  {
    path: '/finance/sales-invoices/create',
    name: 'finance-sales-invoice-create',
    meta: { requiresAuth: true, requiredPermission: 'finance:sales-invoice:create' },
    component: () => import('../modules/finance/SalesInvoiceFormView.vue'),
  },
  {
    path: '/finance/sales-invoices/:id',
    name: 'finance-sales-invoice-detail',
    meta: { requiresAuth: true, requiredPermission: 'finance:sales-invoice:view' },
    component: () => import('../modules/finance/SalesInvoiceDetailView.vue'),
  },
  {
    path: '/finance/sales-invoices/:id/edit',
    name: 'finance-sales-invoice-edit',
    meta: { requiresAuth: true, requiredPermission: 'finance:sales-invoice:update' },
    component: () => import('../modules/finance/SalesInvoiceFormView.vue'),
  },
  {
    path: '/finance/purchase-invoices',
    name: 'finance-purchase-invoices',
    meta: { requiresAuth: true, requiredPermission: 'finance:purchase-invoice:view' },
    component: () => import('../modules/finance/PurchaseInvoiceListView.vue'),
  },
  {
    path: '/finance/purchase-invoices/create',
    name: 'finance-purchase-invoice-create',
    meta: { requiresAuth: true, requiredPermission: 'finance:purchase-invoice:create' },
    component: () => import('../modules/finance/PurchaseInvoiceFormView.vue'),
  },
  {
    path: '/finance/purchase-invoices/:id',
    name: 'finance-purchase-invoice-detail',
    meta: { requiresAuth: true, requiredPermission: 'finance:purchase-invoice:view' },
    component: () => import('../modules/finance/PurchaseInvoiceDetailView.vue'),
  },
  {
    path: '/finance/purchase-invoices/:id/edit',
    name: 'finance-purchase-invoice-edit',
    meta: { requiresAuth: true, requiredPermission: 'finance:purchase-invoice:update' },
    component: () => import('../modules/finance/PurchaseInvoiceFormView.vue'),
  },
  {
    path: '/finance/purchase-invoices/:id/matching',
    name: 'finance-purchase-invoice-matching',
    meta: { requiresAuth: true, requiredPermission: 'finance:purchase-invoice:match' },
    component: () => import('../modules/finance/PurchaseInvoiceMatchingView.vue'),
  },
  {
    path: '/finance/expenses',
    name: 'finance-expenses',
    meta: { requiresAuth: true, requiredPermission: 'finance:expense:view' },
    component: () => import('../modules/finance/ExpenseListView.vue'),
  },
  {
    path: '/finance/expenses/create',
    name: 'finance-expense-create',
    meta: { requiresAuth: true, requiredPermission: 'finance:expense:create' },
    component: () => import('../modules/finance/ExpenseFormView.vue'),
  },
  {
    path: '/finance/expenses/:id',
    name: 'finance-expense-detail',
    meta: { requiresAuth: true, requiredPermission: 'finance:expense:view' },
    component: () => import('../modules/finance/ExpenseDetailView.vue'),
  },
  {
    path: '/finance/expenses/:id/edit',
    name: 'finance-expense-edit',
    meta: { requiresAuth: true, requiredPermission: 'finance:expense:update' },
    component: () => import('../modules/finance/ExpenseFormView.vue'),
  },
  {
    path: '/finance/advance-receipts',
    name: 'finance-advance-receipts',
    meta: { requiresAuth: true, requiredPermission: 'finance:advance-receipt:view' },
    component: () => import('../modules/finance/AdvanceReceiptListView.vue'),
  },
  {
    path: '/finance/advance-receipts/create',
    name: 'finance-advance-receipt-create',
    meta: { requiresAuth: true, requiredPermission: 'finance:advance-receipt:create' },
    component: () => import('../modules/finance/AdvanceReceiptFormView.vue'),
  },
  {
    path: '/finance/advance-receipts/:id',
    name: 'finance-advance-receipt-detail',
    meta: { requiresAuth: true, requiredPermission: 'finance:advance-receipt:view' },
    component: () => import('../modules/finance/AdvanceReceiptDetailView.vue'),
  },
  {
    path: '/finance/advance-receipts/:id/edit',
    name: 'finance-advance-receipt-edit',
    meta: { requiresAuth: true, requiredPermission: 'finance:advance-receipt:update' },
    component: () => import('../modules/finance/AdvanceReceiptFormView.vue'),
  },
  {
    path: '/finance/prepayments',
    name: 'finance-prepayments',
    meta: { requiresAuth: true, requiredPermission: 'finance:prepayment:view' },
    component: () => import('../modules/finance/PrepaymentListView.vue'),
  },
  {
    path: '/finance/prepayments/create',
    name: 'finance-prepayment-create',
    meta: { requiresAuth: true, requiredPermission: 'finance:prepayment:create' },
    component: () => import('../modules/finance/PrepaymentFormView.vue'),
  },
  {
    path: '/finance/prepayments/:id',
    name: 'finance-prepayment-detail',
    meta: { requiresAuth: true, requiredPermission: 'finance:prepayment:view' },
    component: () => import('../modules/finance/PrepaymentDetailView.vue'),
  },
  {
    path: '/finance/prepayments/:id/edit',
    name: 'finance-prepayment-edit',
    meta: { requiresAuth: true, requiredPermission: 'finance:prepayment:update' },
    component: () => import('../modules/finance/PrepaymentFormView.vue'),
  },
  {
    path: '/finance/settlement-workbench',
  ...
  },
  {
    ...
    component: () => import('../modules/finance/VoucherDraftListView.vue'),
  },
  {
    path: '/finance/voucher-drafts/:id',
    name: 'finance-voucher-draft-detail',
    meta: { requiresAuth: true, requiredPermission: 'finance:voucher-draft:view' },
    component: () => import('../modules/finance/VoucherDraftDetailView.vue'),
  },
  {
  ...
  appRouter.beforeEach(async (to) => {
    ...
    if (to.name === 'gl-root') {
      const glRoute = firstGlRouteByPermission((permission) => authStore.hasPermission(permission))
        ?? firstFinancialCloseRouteByPermission((permission) => authStore.hasPermission(permission))
      if (!glRoute) {
        return { name: 'forbidden', query: { from: to.fullPath } }
      }
      return glRoute
