...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    meta: { requiresAuth: true, requiredPermission: 'procurement:order:view' },
    component: placeholder('采购订单', '采购订单页面将在后续任务接入。'),
  },
  {
    ...
    component: placeholder('新建采购订单', '采购订单表单将在后续任务接入。'),
  },
  {
    path: '/procurement/orders/:id',
    name: 'procurement-order-detail',
    meta: { requiresAuth: true, requiredPermission: 'procurement:order:view' },
    component: placeholder('采购订单详情', '采购订单详情页面将在后续任务接入。'),
  },
  {
  ...
  },
  {
    ...
    component: placeholder('新建采购入库', '采购入库表单将在后续任务接入。'),
  },
  {
    path: '/procurement/receipts/:id',
    name: 'procurement-receipt-detail',
    meta: { requiresAuth: true, requiredPermission: 'procurement:receipt:view' },
    component: placeholder('采购入库详情', '采购入库详情页面将在后续任务接入。'),
  },
  {
    ...
    component: placeholder('编辑采购入库', '采购入库编辑页面将在后续任务接入。'),
  },
  {
    path: '/production',
